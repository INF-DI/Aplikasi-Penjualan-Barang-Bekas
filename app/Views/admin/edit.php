            ...
            <form action="<?= base_url('barang/update/' . $barang['id_barang']) ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group-row">
                    <div class="form-group-item">
                        ...
                        <input type="text" class="form-control" id="namaBarang" name="nama_barang" value="<?= old('nama_barang', $barang['nama_barang']) ?>" />
                    </div>
                    <div class="form-group-item">
                ...
                <div class="input-group-row">
                    <div class="form-group-item">
                        ...
                        <input type="text" class="form-control" id="jenisBarang" name="jenis_barang" value="<?= old('jenis_barang', $barang['jenis_barang']) ?>" />
                    </div>
                    <div class="form-group-item">
                        <label for="gambar" class="form-label visually-hidden">Gambar (Kosongkan jika tidak diubah)</label>
                        <input type="file" class="form-control" id="gambar" name="gambar" />
                        <?php if ($barang['gambar']) : ?>
                            <small class="text-muted">Gambar saat ini: <a href="<?= base_url('uploads/' . $barang['gambar']) ?>" target="_blank"><?= $barang['gambar'] ?></a></small>
                        <?php endif; ?>
                    </div>
                </div>
                ...
                <div class="input-group-row">
                    ...
                    <div class="form-group-item">
                        <button type="submit" class="btn btn-save-custom">Update</button>
                    </div>
                </div>
            </form>
        </div>
